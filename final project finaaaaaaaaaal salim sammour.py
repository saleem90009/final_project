...
class Clientlibrarian(GenerateID):
    full_name = ""
    age = None
    id_number = None
...
class Librarian(Clientlibrarian):
    employee_type = ""
...
while True:
    ...
    if (input_type) == 1:
        ...
        librarian.append(Librarian(input("add new id "), input("enter your full name "), input("enter your age "),
        ...
        if not check_client_id(int(client_id)):
            ...
            print("The entered book id not found")
            ...
            print("your borrow id is " + str(borrow_id))
            # borrow_id = borrow_id + 1
...
print(
    "------------------------------------------ labririans -----------------------------------------------------------------")
for i in range(0, len(librarian)):
    print("name = " + librarian[i].get_full_name() + " , id_no = " + librarian[i].get_id_number() + " , phone = " +
          librarian[i].get_employee_type() +
    "\n")
print("-----------------------------------------------------------------------------------------------------------")
...
for i in range(0, len(borrow_orders)):
    print("Client id = " + borrow_orders[i].get_client_id() + " Book id = " + borrow_orders[
        i].get_book_id() + " Status = " + borrow_orders[i].get_status() + "\n")
print("-----------------------------------------------------------------------------------------------------------")
